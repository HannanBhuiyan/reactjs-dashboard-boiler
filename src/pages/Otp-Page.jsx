                            ...
                            <form onSubmit={otpVerifySubmitHandler} > 
                                <div className="form_group mb-7"> 
                                    <div className="flex items-center justify-center ">
                                        ...
                                        className="w-[45px] focus:outline-none focus:border-primaryColor text-center font-robotoFont text-[22px] font-medium h-[45px] rounded-md border-2 mr-3 border-[#04295425] " />
                                        <input 
                                        type="text"
