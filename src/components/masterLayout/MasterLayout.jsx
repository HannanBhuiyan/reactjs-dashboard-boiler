...
import { faTimes, faBars, faEnvelope, faBell, faCheck, faReceipt, faPowerOff, } from "@fortawesome/free-solid-svg-icons";
...
const MasterLayout = (props) => {
    ...
    let sidebarNavRef, contentRef, closeIconRef  = useRef()
    ...
    const handleSidebar = () => {
        ...
        let closeIcon = closeIconRef

        if(sidebarNav.classList.contains('open-nav-open')){
            sidebarNav.classList.add("close_side_nav")
            sidebarNav.classList.remove('open-nav-open')
            ...
            closeIcon.classList.remove('open-icon')
    ...
    return(
        <>
            <div className="main_section flex " >
                <div ref={(div) =>sidebarNavRef=div } className="sidebar open-nav-open bg-[#042954] min-h-screen">
                   <div className="sidebarInner">
                        <div className="sidebar_top flex items-center justify-between bg-primaryColor py-[24px] px-[20px] ">
                            ...
                            <div className="bar" onClick={handleSidebar} >
                                <div className="bar_icon text-[22px] cursor-pointer text-white "><FontAwesomeIcon icon={faBars} /></div>
                            </div>
                        </div>
                        <Sidebar />
                    </div>
                </div>
                <div ref={(div) => contentRef=div} className="main-body bg-[#F0F1F3]">
                    <div className="topbar flex justify-between p-[22px] bg-white items-center shadow-topbar" ref={refOne}>
                        <div className="times_icon" onClick={handleSidebar}>
                            <button ref={(div) => closeIconRef=div} className=" close-icon text-black text-[20px]"><FontAwesomeIcon icon={faTimes} /></button> 
                        </div>
